...
public class StatusBarUtil {
    ...
    private static void setStatusBar(ViewGroup container, @ColorInt int statusBarColor, boolean visible, boolean addToFirst) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (statusBarColor == container.getContext().getResources().getColor(R.color.colorPrimaryDark)) {
                GradientDrawable mNormalBackground = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{statusBarColor, statusBarColor});
                statusBarView.setBackground(mNormalBackground);
            } else statusBarView.setBackgroundColor(statusBarColor);
    ...
    public static int getStatusBarHeight19(Context activity) {
        int result = 0;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
     ...
     */
    public static void addHeightAndPadding(Context context, View view) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
    ...
    public static void setMagining(Activity activity, View view) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            view.setPadding(0, StatusBarUtil.getStatusBarHeight(activity), 0, 0);
        } else {
            view.setPadding(0, 0, 0, 0);
    ...
    public static float getActionHeight(Context mContext) {
