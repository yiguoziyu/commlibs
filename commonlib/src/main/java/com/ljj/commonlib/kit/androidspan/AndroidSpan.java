...
public class AndroidSpan {
     ...
     * @return
     */
    public AndroidSpan drawImageSpan(String text, Context context, int imgId,int fontHeight) {
        Drawable d = context.getResources().getDrawable(imgId);
        d.setBounds(0, 0, fontHeight,fontHeight);
        EmoticonSpan span =new EmoticonSpan(d);
        drawSpan(text, span);
        return this;
    }
